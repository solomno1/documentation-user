...
This type of Reconciliation Model selects automatically the right Customer Invoice or Vendor Bill
...
Accounting Overview, by going to your Bank Journal car, clicking on the three little dots, and then
...
Open the model you want to modify, or click on *Create* to create a new model, then fill out the
form.
