...
Once on your PoS form, select *Global Discounts*. You can find it
...
Click on it and, then, enter the wanted discount.
...
available in the PoS and define a fault one.
...
If you click on it, the price is instantly updated to reflect the
pricelist. Then, you can finalize the order.